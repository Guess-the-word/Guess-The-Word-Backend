...
exports.generateNickname = exports.getRandomWord = exports.wordList = void 0;
...
function getRandomWord() {
    const randomIndex = Math.floor(Math.random() * exports.wordList.length);
    return exports.wordList[randomIndex];
}
